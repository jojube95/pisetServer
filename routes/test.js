...
router.get('/restoreDatabase:id', (req, res, next) => {
  ...
  let restoreProcess = 'mongorestore "mongodb+srv://cluster0.53xnf.mongodb.net/piset-test" -u root -p root --archive=database/test --drop';
...
router.get('/exportDatabase:id', (req, res, next) => {
  ...
  let backupProcess = 'mongodump "mongodb+srv://cluster0.53xnf.mongodb.net/piset-test" -u root -p root --archive=database/test';
